...
export default function ProductCard({ item }) {
    ...
    return (
        <div className="bg-white shadow-lg p-3 w-[250px] h-[480px] transition-transform transform hover:scale-105 hover:bg-secondary flex flex-col justify-between m-1">
